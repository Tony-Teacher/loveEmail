...
function getDayData() {
    return new Promise((resolve, reject) => {
        ...
        // 认识的时间 2021-03-01
        const meet = new Date("2021-03-01");
    ...
    return new Promise((resolve, reject) => {
        request
            ...
            .end((err, res) => {
                ...
                // 空气质量
                const airquality = $(".wea_alert ul li a em").text();
                // 提示
...
async function sendNodeMail() {
    ...
    // 设置电子邮件数据
    let mailOptions = {
        from: "'帅气的小苏哥哥' <974****56@qq.com>", // 发件人邮箱
        to: "106*****96@qq.com", // 收件人列表
...
schedule.scheduleJob("14 20 5 * * *", function() {
    // schedule.scheduleJob("14 11 11 * * *", function() {
    // 时间到了，执行发送邮件的任务
    sendNodeMail();
